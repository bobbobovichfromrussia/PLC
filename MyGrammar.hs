...
happyReduction_6 (HappyAbsSyn4  happy_var_3)
	...
	(HappyAbsSyn4  happy_var_1)
	 =  HappyAbsSyn4
		 (Commands happy_var_1 happy_var_3
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenPrefix -> cont 5;
	TokenCopy -> cont 6;
	TokenArithmetic -> cont 7;
	TokenAccumulator -> cont 8;
	TokenFibonacci -> cont 9;
	TokenNewCommand -> cont 10;
	_ -> happyError' (tk:tks)
	}
...
happyError' :: () => [(MyToken)] -> HappyIdentity a
happyError' = HappyIdentity . parseError

parseShit tks = happyRunIdentity happySomeParser where
